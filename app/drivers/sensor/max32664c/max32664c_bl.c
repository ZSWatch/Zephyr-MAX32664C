...
*/
static int max32664c_bl_i2c_transmit(const struct device *dev, uint8_t* tx_buf, uint8_t tx_len, uint8_t* rx_buf, uint8_t rx_len)
{
    int err;
 ...
 *  @return         0 when successful
*/
static int max32664c_app_i2c_read(const struct device *dev,uint8_t family, uint8_t index, uint8_t* rx_buf, uint8_t rx_len)
{
